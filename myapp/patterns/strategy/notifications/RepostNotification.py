...
class RepostNotification(NotificationInterface):
    ...
    def generate_notification(self, instance, classNotification):
        ...
        classNotification.objects.create(user=instance.user, message = f'{instance.user.first_name} repostou o seu post: {instance.content_object.comment}', content_type = content_type, object_id = instance.id)
        return
