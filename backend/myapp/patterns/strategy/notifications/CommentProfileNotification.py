...
class CommentProfileNotification(NotificationInterface):
    ...
    def generate_notification(self, instance, classNotification):
        ...
        classNotification.objects.create(user=instance.user, message = f'{instance.content_object.user.first_name}, {instance.user.first_name} comentou no seu perfil: {instance.comment}', content_type = content_type, object_id = instance.id)
        return
