...
class CommentOtherNotification(NotificationInterface):
    ...
    def generate_notification(self, instance, classNotification):
        ...
        classNotification.objects.create(profile=instance.user.profile, message = f'{instance.user.first_name} respondeu seu comentário: {instance.comment}', content_type = content_type, object_id = instance.id)
        return
