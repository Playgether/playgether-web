...
class CommentRepostNotification(NotificationInterface):
    ...
    def generate_notification(self, instance, classNotification):
        ...
        classNotification.objects.create(profile=instance.user.profile, message = f'{instance.user.first_name} comentou a sua repostagem: {instance.comment}', content_type = content_type, object_id = instance.id)
        return
