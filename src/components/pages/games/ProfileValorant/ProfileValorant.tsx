  ...
  return (
    <>
      <div className="mt-[-3rem]">
        <h1 className="ProfileValorant-title text-3xl text-center font-extrabold">
          Valorant
        </h1>
      </div>

      <div className="w-full flex justify-center mt-[3rem]">
        <Card className="ProfileValorant-background-cards w-[26rem]">
          <CardHeader>
      ...
      <div className="w-full flex justify-evenly mt-[2rem]">
        <Card className="ProfileValorant-background-cards w-[22rem]">
          <CardHeader>
            <CardTitle className="text-center font-extrabold text-xl">
              Competitivo
            </CardTitle>
          ...
          <CardContent className="flex flex-col items-center justify-center text-xl font-extrabold gap-2 mt-10">
            ...
            <h1 className={winRate >= 50 ? "text-[#24FF00]" : "text-red-500"}>
              {winRate}%
            </h1>
