...
const OnlineFriendsCard = ({}) => {
  return (
    <div className="OnlineFriends-wrapper h-[350px] w-[250px] 2xl:w-[250px] max-h-[350px] rounded-2xl flex items-center flex-col gap-3">
      ...
      <OnlineFriendsList />
      <div className="OnlineFriendsCard-expand text-center pt-4 font-medium">
        <a href="">
          <h1>Ver Todos</h1>
        </a>
      </div>
