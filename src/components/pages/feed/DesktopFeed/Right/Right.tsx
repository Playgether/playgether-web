...
const Right = () => {
  return (
    <div className="w-full 2xl:sticky top-16 h-full 2xl:h-fit min-w-[350px]">
      <div className="flex-1 h-full flex flex-col space-y-4">
        ...
        {/* Segundo Card */}
        <div className="Right-topics grow flex mt-2 flex-col rounded-2xl w-10/12 2xl:w-[374px] min-h-[300px] h-[350px] max-h-[350px] 2xl:max-h-[400px] 2xl:static sticky top-[calc(4rem+16px)]">
