...
import PostHasNoMedia from "./PostHasMedia/PostHasNoMedia";
...
const ResponsivePostsExtend = ({ onClose, resource, slideIndex }: PostsExtendProps) => {
  ...
  return (
    <>
      ...
      />
      <div
        className="fixed z-50 flex left-0 right-0 justify-center bottom-[65px] mx-auto w-full h-[100vh] bg-white shadow-lg bg-black-300 bg-opacity-50"
...
export default ResponsivePostsExtend;
