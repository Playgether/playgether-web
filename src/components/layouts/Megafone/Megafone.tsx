...
const Megafone = ({}) => {
  return (
    <>
      <div className="w-screen max-w-[100%] h-16 bottom-0 flex overflow-x-hidden overflow-y-hidden z-50">
        <div className="Megafone-wrapper h-full flex items-center relative z-20">
          <div className="inset-0 bg-purple-600 absolute blur-sm bg-gradient-to-r from-pink-400 via-purple-500 to-purple-500 animate-moveRight"></div>
