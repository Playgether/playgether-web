...
const GlobalChat = ({}) => {
  return (
    <>
      <div className="w-full h-16 bottom-0 flex overflow-x-hidden overflow-y-hidden z-50">
        <div className="GlobalChat-wrapper h-full flex items-center relative z-20">
