        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <div className="flex justify-between items-center">
              ...
              <span className="text-xs ChatConversations-message">
                {chat.time}
              </span>
            </div>
            <p className="text-sm ChatConversations-message truncate">
              {chat.message}
            </p>
          </div>
          {idx === 2 && (
            <div className="h-2 w-2 ChatConversations-new-message rounded-full ml-2"></div>
          )}
        </div>
      ))}
    </div>
