    ...
    return (
        ...
        >
            <div className="flex flex-col bg-white justify-center items-center h-60 gap-6 pt-16 rounded-lg p-16">
                <p className="text-black-400">Este é exemplo de um modal com duas opções</p>
                <OrangeButton className="py-4 px-4" onClick={() => action("Você continuou com a ação")()}>Continuar</OrangeButton>
                <ButtonClose onClick={() => {
                    action('Você fechou o Modal')();
                    setShouldShow(false);
                }}>Fechar</ButtonClose>
